...
long int getOperand(int operand) {
    switch (operand) {
        case 0:
            return 0;
        case 1:
...
int main(void) {
    ...
    do {
        ...
        for (i = 0; i < proglen; ) {
            ...
            long int operandCombo = getOperand(operand);
            int newI = 0;
            switch (prog[i]) {
                case 0:
                    A = (long int) (A / ((long int) pow(2, operandCombo)));
                    break;
                case 1:
                    B = B ^ operand;
                    break;
                ...
                case 5:
                    ...
                    break;
                case 6:
                    B = (long int) (A / ((long int) pow(2, operandCombo)));
                    break;
                case 7:
                    C = (long int) (A / ((long  int) pow(2, operandCombo)));
                    break;
            }
            if (!newI) {
                i += 2;
